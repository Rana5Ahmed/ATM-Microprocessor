...
fullmoney:
    ...
    mov dx,offset newline    ; memory location of message "new line"     
    int 21h
    mov dx,offset reached_50k    ; memory location of message "Function done"     
    int 21h     ; dos interrupt 21h
    mov dx,offset newline    ; memory location of message "new line"     
    int 21h
...
;    mov bx,balancemoney
;    mov tempmoney,bx
;cont_moneytofile:                        ;12345          12345   1234    12340    5432 
;    mov ax,tempmoney
    ;shr ax,4
    ;shl ax,4
;    mov cl,al
...
;    sub bx,ax
;    ;mov bx,ax
;    mov ax,reversedbalance
;    mul numberplace
;    add ax,bx
;    mov reversedbalance,ax
;    mov ax,tempmoney
;    div numberplace
;    mov tempmoney,ax
;    cmp tempmoney,0
