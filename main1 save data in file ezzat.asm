...
log_user1:
    ...
    mov current_user,1  ;know which user
...
entermoney:
    ...
    mov counter, 0 ;counter is the variable that contain number of digits
    mov ah,09h ; dos function 09h to print a string
...
scan_money:
    ...
    cmp money,50000
    je numberdone
    mov ah,1  ; dos function to read a character with echo from keyboard      ;5 0 0 0 0
    int 21h   ; dos interrupt 21h
